...
(function($) {
	$.fn.amazingaudioplayer = function(options) {
		...
		//	if (this.options.showtracklist) {
				this.$tracklistwrapper = $("<div id='musiclist' class='amazingaudioplayer-tracklist'></div>");
				this.$tracklistwrapper.appendTo(this.container);
				this.$tracklistwrapper.css({
					display : "block",								//初始化时隐藏播放列表
					height : "auto"
				});
			...
			if (true) {
				var $musiclist = $("<div class='amazingaudioplayer-musiclist'></div>");
				$musiclist.appendTo($bar).css({
						display : "block",
						overflow : "hidden",
						position : "relative",
				...
				$musiclist.click(function() {
					...
					if($musiclist.style.display == "none"){
						...
						//document.getElementById("musiclist").style.top = "-300px";
						//document.getElementById("amazingaudioplayer-1").style.top = "-254px";
						//document.getElementById("amazingaudioplayer-1").style.height = "24px";
						document.getElementById("musiclist").style.display = "";
					}else{
						//document.getElementById("amazingaudioplayer-1").style.top = "0px";
						//document.getElementById("amazingaudioplayer-1").style.height = "24px";
